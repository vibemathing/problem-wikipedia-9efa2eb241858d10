...
```json
{
  ...
  "problem_contract": {
    ...
    "aliases": [
      "wikipedia:wikipedia-9efa2eb241858d10"
    ],
    "allowed_axioms": [
    ...
    "problem_id": "problem:wikipedia-9efa2eb241858d10",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "wikipedia-9efa2eb241858d10",
        "url": "https://en.wikipedia.org/wiki/Prime_number"
      }
    ],
    "statement": {
      "language": "en",
      "text": "Dubner's conjecture: every even number greater than $4208$ is the sum of two primes which both have a twin .",
      "version": 1
    },
    "title": "Dubner's conjecture",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "99863692c3d6c2c26cbff8e7b4c5db97b4f62f82635012794a4f56d1b9b6c864"
}
```
